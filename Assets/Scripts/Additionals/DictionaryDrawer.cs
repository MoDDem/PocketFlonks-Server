...
public class MyDictionaryDrawer1 : DictionaryDrawer<int, Player> { }

[CustomPropertyDrawer(typeof(ConnectionDictionary))]
public class MyDictionaryDrawer2 : DictionaryDrawer<int, UserConnection> { }
